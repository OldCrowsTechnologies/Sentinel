...
const REFERENCES: Record<string, DroneReference> = {
  ...
  'DJI Mini 3 Pro': {
    ...
    model: 'Mini 3 Pro',
    build: 'Commercial — consumer (sub-250 g)',
    type: 'Folding camera quadcopter',
    rotors: 4,
    size: '≈ 14.5 cm folded',
    weight: '≈ 249 g (0.55 lb)',
    role: 'Consumer photography; 249 g stays under the FAA registration line',
    image: null,
  },
  'DJI Mini 5 Pro': {
    ...
    size: '≈ 15 cm folded',
    weight: '≈ 249 g (0.55 lb)',
    role: 'Consumer photography; sub-250 g micro',
    image: null,
  },
  'DJI FPV': {
    label: 'DJI FPV',
    ...
    make: 'DJI',
    model: 'FPV',
    build: 'Commercial — consumer FPV',
    type: 'High-speed FPV quadcopter',
    rotors: 4,
    size: '≈ 25 cm',
    weight: '≈ 795 g (1.75 lb)',
    role: 'High-speed first-person-view flight; fast + agile',
    image: null,
  },
  'DJI Mavic 3': {
    label: 'DJI Mavic 3',
    ...
    make: 'DJI',
    model: 'Mavic 3',
    build: 'Commercial — prosumer',
    type: 'Folding camera quadcopter',
    rotors: 4,
    size: '≈ 35 cm unfolded',
    weight: '≈ 895 g (2.0 lb)',
    role: 'Prosumer aerial imaging; long range/endurance',
    image: null,
  },
  'Yuneec': {
    label: 'Yuneec',
    displayName: 'Yuneec (Typhoon-class hex)',
    faaClass: 'small',
    make: 'Yuneec',
    model: 'Typhoon H-class',
    build: 'Commercial — prosumer hexacopter',
    type: 'Hexacopter camera drone',
    rotors: 6,
    size: '≈ 52 cm',
    weight: '≈ 1.95 kg (4.3 lb)',
    role: 'Prosumer/industrial hexacopter; 6 rotors = redundancy',
    image: null,
  },
