...
const cfg={sampleRate:model.dsp.sampleRate,nfft:model.dsp.nfft,hop:model.dsp.hop,nMels:model.dsp.nMels,bandRatios:model.dsp.bandRatios,melFilterbank:model.dsp.melFilterbank,highPass:model.dsp.highPass,stationarity:model.dsp.stationarity,harmonics:model.dsp.harmonics};
