-- Corvus Sentinel C2 — ONE-PASTE deploy for the ECSO Blue Angels demo.
-- Paste this entire file into the Supabase SQL Editor (new project) and Run.
-- It builds the C2 schema (0001) then the 30-day demo tenant + codes (0002).
